...
int home() {
    ...
    cout << "8. Check File Info" << endl;
    cout << "9. Minigames" << endl;
    cout << "0. Exit" << endl;
    cout << "Press -1 to Switch to Kernal mode" << endl;
...
int kernal_menu() {
    ...
    // logo();
    cout << "Select an option:" << endl;
    cout << "1. Show Running Processes" << endl;
    cout << "2. Modify Processes Properties" << endl;
    cout << "3. Close Running Processes" << endl;
    cout << "4. Switch to User mode" << endl;
    cout << "Choice: ";
    check_for_closed_process();
    cin >> choice;
    cout << "::OUTPUT::" << endl; 
